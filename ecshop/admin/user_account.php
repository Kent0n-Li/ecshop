...
elseif ($_REQUEST['act'] == 'insert' || $_REQUEST['act'] == 'update')
{
    ...
    $bank_addr    = !empty($_POST['bank_addr'])    ? trim($_POST['bank_addr'])        : '';
    ...
    if ($_REQUEST['act'] == 'insert')
    {
        ...
        $sql = "INSERT INTO " .$ecs->table('user_account').
               " VALUES ('', '$user_id', '$_SESSION[admin_name]', '$amount', '".gmtime()."', '".gmtime()."', '$admin_note', '$user_note', '$process_type', '$payment', '$is_paid','$bank_addr','$bank_account')";
        $db->query($sql);
        $id = $db->insert_id();
    }
    else
